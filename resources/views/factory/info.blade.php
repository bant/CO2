            ...
            <table id="companyTable" class="table table-bordered table-striped companyTable">
              ...
              <tbody>
                ...
                @if($factory->company->getPrtrCo2()!=0)
                  <a href="http://prtr.toxwatch.net/company/info?id={{$factory->company->getPrtrCo2()}}" target=”_blank”title="{{$factory->company->name}}のPRTR情報はこちら">{{$factory->company->name}}のPRTR情報はこちら</a>
                @else 
                  なし
                @endif   
                </td>
